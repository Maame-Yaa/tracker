import { GoogleMap, LoadScript, Polygon, OverlayView, Marker } from '@react-google-maps/api'
...
function ViewAllMaps({latitude, longitude}) {
  ...
  return (
    ...
    {/* <h3>Total Geofences : {geoState && geoState.length}</h3> */}
