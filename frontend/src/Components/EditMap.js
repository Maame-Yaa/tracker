...
function EditMap({apiKey,paths,point,center,setPoint,close,id,color,setColor}) {
    ...
    return (
        ...
        {/* </LoadScript>  */}
        <br/>
        <select className="custom-button" value={editColor} onChange={handleColorChange}>
        ...
        <br/>
        <button className="custom-button" onClick={updateMap}>Update</button>
        <button className="custom-button" onClick={close}>Close</button>
